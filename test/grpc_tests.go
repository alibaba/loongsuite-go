...
func init() {
	TestCases = append(TestCases,
		...
		NewMuzzleTestCase("grpc-muzzle", grpc_dependency_name, grpc_module_name, "v1.70.0", "", "1.21", "", []string{"go", "build", "test_grpc_basic.go", "grpc_common.go", "grpc.pb.go", "grpc_grpc.pb.go"}),
