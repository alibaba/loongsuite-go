...
import (
	...
	messagev1 "github.com/alibaba/loongsuite-go-agent/example/kratos-demo/api/message"
	v1 "github.com/alibaba/loongsuite-go-agent/example/kratos-demo/api/weather"
